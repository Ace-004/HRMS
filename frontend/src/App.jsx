...
const App = () => {
  return (
    <Routes>
      ...
      <Route path="/auth/:role" element={<PublicRoute><AuthLogin /></PublicRoute>} />
      ...
      <Route path="/my-profile" element={<ProfileRequiredRoute><MyProfile /></ProfileRequiredRoute>} />
      <Route path="/attendance" element={<ProfileRequiredRoute><Attendance /></ProfileRequiredRoute>} />
      <Route path="/leaves" element={<ProfileRequiredRoute><Leaves /></ProfileRequiredRoute>} />
      <Route path="/payroll" element={<ProfileRequiredRoute><Payroll /></ProfileRequiredRoute>} />
      <Route path="/announcements" element={<ProfileRequiredRoute><Announcements /></ProfileRequiredRoute>} />
      ...
      <Route path="/leave-management" element={<AdminOrHrRoute><LeaveManagement /></AdminOrHrRoute>} />
      <Route path="/employees" element={<AdminOrHrRoute><Employees /></AdminOrHrRoute>} />
      <Route path="/employees/:id" element={<AdminOrHrRoute><EmployeeDetail /></AdminOrHrRoute>} />
      <Route path="/register" element={<AdminOrHrRoute><Register /></AdminOrHrRoute>} />
